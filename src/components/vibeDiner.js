    ...
    <div className="App">
      <Layout>
        ...
        <div className="website-screenshots" id="vibediner-screenshots">
          <img alt="sorting" src={require("../img/vibe-diner-home.png")} />
          <img alt="sorting" src={require("../img/vibe-diner-feed.png")} />
          <img alt="home tab" src={require("../img/vibe-diner-profile.png")}/>
          <img alt="progress chart" src={require("../img/vibe-diner-messages.png")} />
        </div>
        </Content>
